...
def plot_results(data, simple_values, test_values, simple_monthly, test_monthly):
    ...
    plt.bar(simple_monthly_totals["YearMonth"], simple_monthly_totals["Investment"], width=20, alpha=0.3, label="Простая стратегия: Пополнения", color="blue")
...
def main():
    ...
    with open(report_path, "w") as report_file:
        ...
        report_file.write(simple_monthly.groupby("YearMonth")["Investment"].sum().to_string())
